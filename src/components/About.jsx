function About() {
    return (
        <div style={{ fontSize: "var(--text-m)", fontWeight: "200" }}>
            My name is Luca, born and raised in the Netherlands, and I am a recent graduate from National Taiwan University (NTU) with a Master's
            ...
            research assistant in NTU's <a href="https://mikechen.com">Human-Computer Interaction (HCI) laboratory</a> where I have spent my time
            researching and integrating novel haptic technologies and virtual reality applications. Some of my research has even been published and
            ...
            a role, please <a href="#contact">reach out</a>! All opportunities will be considered.
        </div>
    );
}
